/**
 *
 * this file is forked from the library react-otp-input version 3.1.1
 * with only 2 small changes in onChange function and onInputChange function
 * persianNumbersToEnglish convertor is added to accept persian numbers
 *
 */
...
const OTPInput = ({
  ...
  const handleChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const convertedValue = persianNumbersToEnglish(_value);

    if (isInputValueValid(convertedValue)) {
  ...
  const handleInputChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const value = persianNumbersToEnglish(event.target.value);
